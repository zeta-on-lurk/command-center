...
insert into sections (id, department_id, name, group_name, room_number, capacity) values
    ('s0000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000001', 'Section A', 'Pre-Medical A', 'Room 101', 60),
    ('s0000000-0000-0000-0000-000000000002', 'd0000000-0000-0000-0000-000000000001', 'Section B', 'Pre-Medical B', 'Room 102', 60),
    ('s0000000-0000-0000-0000-000000000003', 'd0000000-0000-0000-0000-000000000002', 'Section A', 'Pre-Engineering A', 'Room 201', 60),
    ('s0000000-0000-0000-0000-000000000004', 'd0000000-0000-0000-0000-000000000002', 'Section B', 'Pre-Engineering B', 'Room 202', 60),
    ('s0000000-0000-0000-0000-000000000005', 'd0000000-0000-0000-0000-000000000003', 'Section A', 'ICS A (Physics-Maths-CS)', 'Room 301', 60),
    ('s0000000-0000-0000-0000-000000000006', 'd0000000-0000-0000-0000-000000000004', 'Section A', 'ICom A', 'Room 401', 60),
    ('s0000000-0000-0000-0000-000000000007', 'd0000000-0000-0000-0000-000000000005', 'Section A', 'FA Group I', 'Room 501', 60)
on conflict (id) do nothing;
...
insert into students (id, college_id, section_id, name, father_name, gender, city, matric_percentage, matric_year) values
    ('st000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000001', 's0000000-0000-0000-0000-000000000001', 'Abdullah Khan', 'Khalid Khan', 'male', 'Lahore', 85.5, 2024),
    ('st000000-0000-0000-0000-000000000002', 'a0000000-0000-0000-0000-000000000001', 's0000000-0000-0000-0000-000000000001', 'Ayesha Malik', 'Tariq Malik', 'female', 'Lahore', 92.1, 2024),
    ('st000000-0000-0000-0000-000000000003', 'a0000000-0000-0000-0000-000000000001', 's0000000-0000-0000-0000-000000000003', 'Bilal Hussain', 'Imran Hussain', 'male', 'Lahore', 78.3, 2024),
    ('st000000-0000-0000-0000-000000000004', 'a0000000-0000-0000-0000-000000000001', 's0000000-0000-0000-0000-000000000001', 'Daniyal Ahmed', 'Shahid Ahmed', 'male', 'Lahore', 88.7, 2024),
    ('st000000-0000-0000-0000-000000000005', 'a0000000-0000-0000-0000-000000000001', 's0000000-0000-0000-0000-000000000005', 'Fatima Noor', 'Asad Noor', 'female', 'Lahore', 90.2, 2024),
    ('st000000-0000-0000-0000-000000000006', 'a0000000-0000-0000-0000-000000000001', 's0000000-0000-0000-0000-000000000003', 'Hamza Tariq', 'Mehmood Tariq', 'male', 'Lahore', 72.4, 2024),
    ('st000000-0000-0000-0000-000000000007', 'a0000000-0000-0000-0000-000000000001', 's0000000-0000-0000-0000-000000000003', 'Ibrahim Shah', 'Rashid Shah', 'male', 'Lahore', 81.6, 2024),
    ('st000000-0000-0000-0000-000000000008', 'a0000000-0000-0000-0000-000000000001', 's0000000-0000-0000-0000-000000000007', 'Khadija Begum', 'Nasir Beg', 'female', 'Lahore', 76.8, 2024),
    ('st000000-0000-0000-0000-000000000009', 'a0000000-0000-0000-0000-000000000001', 's0000000-0000-0000-0000-000000000001', 'Muzammil Ali', 'Farooq Ali', 'male', 'Lahore', 83.9, 2024),
    ('st000000-0000-0000-0000-000000000010', 'a0000000-0000-0000-0000-000000000001', 's0000000-0000-0000-0000-000000000005', 'Nadia Parveen', 'Kamran Parveen', 'female', 'Lahore', 87.3, 2024),
    ('st000000-0000-0000-0000-000000000011', 'a0000000-0000-0000-0000-000000000001', 's0000000-0000-0000-0000-000000000003', 'Omar Farooq', 'Yousaf Farooq', 'male', 'Lahore', 79.5, 2024),
    ('st000000-0000-0000-0000-000000000012', 'a0000000-0000-0000-0000-000000000001', 's0000000-0000-0000-0000-000000000007', 'Zainab Noor', 'Tariq Noor', 'female', 'Lahore', 74.2, 2024)
on conflict (id) do nothing;
...
insert into attendance_daily (college_id, student_id, section_id, date, status, time_in, remarks) values
    ('a0000000-0000-0000-0000-000000000001', 'st000000-0000-0000-0000-000000000001', 's0000000-0000-0000-0000-000000000001', current_date, 'present', '07:45', null),
    ('a0000000-0000-0000-0000-000000000001', 'st000000-0000-0000-0000-000000000002', 's0000000-0000-0000-0000-000000000001', current_date, 'present', '07:50', null),
    ('a0000000-0000-0000-0000-000000000001', 'st000000-0000-0000-0000-000000000003', 's0000000-0000-0000-0000-000000000003', current_date, 'absent', null, '5th consecutive absence'),
    ('a0000000-0000-0000-0000-000000000001', 'st000000-0000-0000-0000-000000000004', 's0000000-0000-0000-0000-000000000001', current_date, 'late', '08:15', 'Late by 15 minutes'),
    ('a0000000-0000-0000-0000-000000000001', 'st000000-0000-0000-0000-000000000005', 's0000000-0000-0000-0000-000000000005', current_date, 'present', '07:40', null),
    ('a0000000-0000-0000-0000-000000000001', 'st000000-0000-0000-0000-000000000006', 's0000000-0000-0000-0000-000000000003', current_date, 'absent', null, '2nd consecutive absence'),
    ('a0000000-0000-0000-0000-000000000001', 'st000000-0000-0000-0000-000000000007', 's0000000-0000-0000-0000-000000000003', current_date, 'present', '07:55', null),
    ('a0000000-0000-0000-0000-000000000001', 'st000000-0000-0000-0000-000000000008', 's0000000-0000-0000-0000-000000000007', current_date, 'present', '07:48', null),
    ('a0000000-0000-0000-0000-000000000001', 'st000000-0000-0000-0000-000000000009', 's0000000-0000-0000-0000-000000000001', current_date, 'absent', null, 'Medical leave'),
    ('a0000000-0000-0000-0000-000000000001', 'st000000-0000-0000-0000-000000000010', 's0000000-0000-0000-0000-000000000005', current_date, 'late', '08:20', 'Late by 20 minutes'),
    ('a0000000-0000-0000-0000-000000000001', 'st000000-0000-0000-0000-000000000011', 's0000000-0000-0000-0000-000000000003', current_date, 'present', '07:42', null),
    ('a0000000-0000-0000-0000-000000000001', 'st000000-0000-0000-0000-000000000012', 's0000000-0000-0000-0000-000000000007', current_date, 'absent', null, '4th consecutive absence')
...
insert into lectures (college_id, faculty_id, section_id, subject, date, period_number, topic_covered, status) values
    ('a0000000-0000-0000-0000-000000000001', 'f0000000-0000-0000-0000-000000000001', 's0000000-0000-0000-0000-000000000001', 'Physics', current_date, 1, 'Optics — Reflection & Refraction', 'delivered'),
    ('a0000000-0000-0000-0000-000000000001', 'f0000000-0000-0000-0000-000000000002', 's0000000-0000-0000-0000-000000000001', 'Chemistry', current_date, 2, 'Organic Reactions — Esterification', 'delivered'),
    ('a0000000-0000-0000-0000-000000000001', 'f0000000-0000-0000-0000-000000000004', 's0000000-0000-0000-0000-000000000001', 'Biology', current_date, 3, 'Human Heart — Cardiac Cycle', 'delivered'),
    ('a0000000-0000-0000-0000-000000000001', 'f0000000-0000-0000-0000-000000000006', 's0000000-0000-0000-0000-000000000005', 'Computer Science', current_date, 1, 'C++ — Pointers & Memory', 'delivered'),
    ('a0000000-0000-0000-0000-000000000001', 'f0000000-0000-0000-0000-000000000007', 's0000000-0000-0000-0000-000000000003', 'Physics', current_date, 2, 'Mechanics — Newton Laws', 'delivered'),
    ('a0000000-0000-0000-0000-000000000001', 'f0000000-0000-0000-0000-000000000008', 's0000000-0000-0000-0000-000000000002', 'Chemistry', current_date, 3, 'Periodic Table — Trends', 'delivered')
...
insert into syllabus_progress (college_id, section_id, subject, chapter_name, chapter_number, total_topics, completed_topics, target_date, faculty_id) values
    ('a0000000-0000-0000-0000-000000000001', 's0000000-0000-0000-0000-000000000001', 'Physics', 'Optics', 8, 12, 11, '2026-04-15', 'f0000000-0000-0000-0000-000000000001'),
    ('a0000000-0000-0000-0000-000000000001', 's0000000-0000-0000-0000-000000000001', 'Chemistry', 'Organic Chemistry', 14, 15, 14, '2026-04-20', 'f0000000-0000-0000-0000-000000000002'),
    ('a0000000-0000-0000-0000-000000000001', 's0000000-0000-0000-0000-000000000001', 'Biology', 'Human Physiology', 10, 14, 12, '2026-04-18', 'f0000000-0000-0000-0000-000000000004'),
    ('a0000000-0000-0000-0000-000000000001', 's0000000-0000-0000-0000-000000000003', 'Mathematics', 'Calculus', 6, 10, 7, '2026-04-10', 'f0000000-0000-0000-0000-000000000003'),
    ('a0000000-0000-0000-0000-000000000001', 's0000000-0000-0000-0000-000000000005', 'Computer Science', 'Programming in C++', 5, 8, 7, '2026-04-12', 'f0000000-0000-0000-0000-000000000006'),
    ('a0000000-0000-0000-0000-000000000001', 's0000000-0000-0000-0000-000000000003', 'Physics', 'Mechanics', 4, 10, 6, '2026-04-08', 'f0000000-0000-0000-0000-000000000007')
on conflict do nothing;
